...
flowchart LR
    ...
    A[Engine Cycles Increase]
    --> B[Exponential Module Degradation]

    B --> C[Efficiency Loss]
    B --> D[Flow Capacity Loss]

    C --> E[Engine Thermodynamic State Changes]
    D --> E

    E --> F[Temperature Changes]
    E --> G[Pressure Changes]
    E --> H[Shaft Speed Changes]

    F --> I[Sensor Readings Change]
    G --> I
    H --> I

    I --> J[LSTM Uses Last 30 Cycles]

    J --> K[Predicted Remaining Useful Life]
